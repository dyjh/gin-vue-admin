...
import userModel "github.com/dyjh/order-food-mini-app/server/model/user"
...
type UpdateUserStatusBody struct {
	Status          userModel.UserStatus `json:"status" binding:"required,oneof=normal disabled"` // 状态
