...
type PointEntry struct {
	...
	Administrator     *commonResponse.AdministratorSummary `json:"administrator"`     // 操作管理员
...
type PointAdjustmentPreview struct {
	...
	User                commonResponse.UserReference `json:"user"`                // 目标用户
...
type PointRuleConfig struct {
	...
	UpdatedBy          commonResponse.AdministratorSummary `json:"updatedBy"`          // 更新人
