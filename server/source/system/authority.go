...
import (
	"context"
	sysModel "github.com/dyjh/order-food-mini-app/server/model/system"
...
func (i *initAuthority) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []sysModel.SysAuthority{
		{AuthorityId: 888, AuthorityName: "普通用户", ParentId: utils.Pointer[uint](0), DefaultRouter: "OrderFoodDashboard"},
		{AuthorityId: 9528, AuthorityName: "测试角色", ParentId: utils.Pointer[uint](0), DefaultRouter: "about"},
		{AuthorityId: 8881, AuthorityName: "普通用户子角色", ParentId: utils.Pointer[uint](888), DefaultRouter: "about"},
	}
