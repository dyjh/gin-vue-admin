...
// PermissionModerationRead is shared by content moderation and recommendation APIs.
const PermissionModerationRead = "orderfood:moderation:read"
...
func DefaultRolePermissionMatrix() map[uint][]string {
	...
	matrix[commonModel.AuthorityPlatformSuperAdmin] = append(
		[]string(nil),
		matrix[commonModel.AuthorityOrderFoodSuperAdmin]...,
	)
	return matrix
}
