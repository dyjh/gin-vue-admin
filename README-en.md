...
[github](https://github.com/dyjh/order-food-mini-app): https://github.com/dyjh/order-food-mini-app
...
- [gin-vue-admin_v2_dev](https://github.com/dyjh/order-food-mini-app/tree/gin-vue-admin_v2_dev) (v2.0 [GormV1](https://v1.gorm.io) Stable branch)
- [gva_gormv2_dev](https://github.com/dyjh/order-food-mini-app/tree/gva_gormv2_dev) (v2.0 [GormV2](https://v2.gorm.io) Development branch)
...
- Restful example: You can see sample APIs in user management module.
  - Front-end file reference: [web/src/view/superAdmin/api/api.vue](https://github.com/dyjh/order-food-mini-app/blob/master/web/src/view/superAdmin/api/api.vue).
  - Stage reference: [server/router/sys_api.go](https://github.com/dyjh/order-food-mini-app/blob/master/server/router/sys_api.go).
...
<a href="https://github.com/dyjh/order-food-mini-app/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=dyjh/order-food-mini-app" />
</a>
